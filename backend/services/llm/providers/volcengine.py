"""
VolcEngine LLM Service - Anthropic Messages API protocol compatible
...
class VolcengineLLMService(BaseLLMService):
    """VolcEngine LLM service using Anthropic Messages API protocol"""

    def __init__(self):
        self.base_url = settings.volcengine_coding_plan_url
        self.auth_token = settings.volcengine_coding_plan_auth_token
        self.model = settings.volcengine_coding_plan_model
    ...
    async def chat_stream(
        ...
        """Stream chat completions from VolcEngine (Anthropic-compatible API)"""
        if not self.is_configured():
            yield "Error: VolcEngine not configured: missing base_url or auth token"
            return
