...
from services.speech.providers.aliyun_asr import AliyunASRService as ASRService
...
async def test_asr_recognize_missing_config():
    ...
    with patch("services.speech.providers.aliyun_asr.settings") as mock_settings:
...
async def test_asr_recognize_valid_config_but_bad_response():
    ...
    with patch("services.speech.providers.aliyun_asr.settings") as mock_settings:
        ...
        with patch("services.speech.providers.aliyun_asr._client.post") as mock_post:
